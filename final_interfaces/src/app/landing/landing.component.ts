...
export class LandingComponent {
  ...
  row3: Track[] = [
    { title: 'J-pop Mix', artist: 'Pekoe', collection: 'Playlist', coverart: 'jpop.png', year: 2020, rating: 2, isPlaylist: true },
  ]

  row4: Track[] = [
    {
      title: 'How a Trip to Japan\'s Worst Place Backfired | Feat. Ryotaro\'s Japan', artist: 'Abroad in Japan', collection: 'Podcast', coverart: 'abroad.png', year: 2020, rating: 4, isPodcast: true
    },
    { title: 'Japan\'s Earthquakes Are Terrifying', artist: 'Trash Taste', collection: 'Podcast', coverart: 'trashtaste.jpg', year: 2020, rating: 4, isPodcast: true },
  ]
}